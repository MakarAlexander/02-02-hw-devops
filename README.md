...
В папке Terraform в файле ".gitignore" содержатся переменные, кототые будут игнорироваться при коммитах. Такие как файлы с расширение .terraform, .tfstate, логи поломок и другие.

Добавление новой строки для задания hw-02-02-devops c копирование репозитория hw-02-01-devops